...
class Plan(models.Model):
    ...
    start_date = models.DateTimeField(null=False)   # prebaciti
    end_date = models.DateTimeField(null=False)     # u productionorder
    producable_amount = models.PositiveIntegerField(null=False)  # prekrstiti u amount_to_produce
...
def update_plan_status(sender, instance, created, **kwargs):
    if created:
        plan_to_update = Plan.objects.get(id=instance.plan.id)
